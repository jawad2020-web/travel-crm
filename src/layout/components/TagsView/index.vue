...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      //Dynamic Assembly Styles Menu Indentation
      ...
      // tags drop-down menu on the right
      ...
      // Synchronize the latest routing information to localStorage
      ...
      function onScroll(e) {
        let scrollTop =
          ...
          window.pageYOffset ||
          document.body.scrollTop; // scrollbar offset
       ...
       * @param amplitude the length of each scroll
       */
      ...
      /**
       * @param autoScroll Whether to enable the automatic scrolling function
       */
